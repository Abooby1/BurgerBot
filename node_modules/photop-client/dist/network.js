...
const IMAGE_UPLOAD_URL = "https://phosocket.exotek.co:3000/ImageUpload";
class Network {
    constructor(credentials, config) {
        var _a, _b;
        this.config = config;
        this.simpleSocket = new simplesocket_1.default({
        ...
        this.simpleSocket.showDebug = (_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.logSocketMessages) !== null && _b !== void 0 ? _b : false;
    ...
    _init(credentials) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_a = this.config) === null || _a === void 0 ? void 0 : _a.disableGroups) !== true) {
                this.groupInvitesSub = this.simpleSocket.subscribe({ Task: "NewGroupInvite", UserID: this.userid }, (Data) => {
                    this.onInvite(Data);
                });
